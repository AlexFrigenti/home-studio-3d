...
function legacyDeclaredTasks(requirements) {
  return [...new Set(collectTaskIds(requirements))].sort();
}
...
export async function loadProjectCapabilityRequirements(projectRoot, { catalog }) {
  ...
  return {
    ...
    declaredTasks: inputs.declaredTasks ?? legacyDeclaredTasks(normalizedRequirements),
