...
export function createHandoffMaterializationRequest({ sessionInputs, surface, projectSkillMetadata } = {}) {
  ...
  if (typeof projectSkillMetadata?.name === "string" && projectSkillMetadata.name.length > 0) {
    request.nativeSkill = { name: projectSkillMetadata.name };
  }
  return request;
}
